...
class HtmlMimeMail5
{
    ...
    */
    public function __construct()
    {
        ...
        */
        ...
        //var_dump($this->smtp_params);exit;
    ...
    */
    ...
    {
        //var_dump($host, $port, $helo, $auth, $user, $pass);exit;
    ...
    */
    public function build()
    {
        ...
        if (isset($message)) {
            ...
            //$message_id = sprintf('<%s.%s@%s>', time(), rand(), $hostname);
        ...
        switch ($type) {
            ...
            case 'smtp':
                ...
                if (!$smtp->send($send_params)) {
                    ...
                    //var_dump($send_params, $this->errors);exit;
                    return false;
                }
                return true;
                break;
